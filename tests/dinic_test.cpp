...
static void SimpleTest(httplib::Client *cli) {
    ...
    nlohmann::json input = R"(
  {
    ...
    for (int i = 0; i < output.at("numEdges"); i++) {// Перебор ребер
    ...
    nlohmann::json input1 = R"(
  {
    ...
    for (int i = 0; i < output1.at("numEdges"); i++) {// Перебор ребер
    ...
    nlohmann::json input2 = R"(
  {
    ...
    for (int i = 0; i < output2.at("numEdges"); i++) {// Перебор ребер
...
static void RandomTest(httplib::Client *cli) {
  ...
  for (int id = 0; id < numTries; id++) {
    ...
    size_t s = 0, t = 0;
    for (int i = 0; i < output.at("numEdges"); i++) {
